...
This is the distribution package for the [CardView extension](https://datatables.net/extensions/cardview) for [DataTables](https://datatables.net/) with styling for [DataTables](https://datatables.net/).
